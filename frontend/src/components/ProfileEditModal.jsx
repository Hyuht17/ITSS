 ...
 * モーダル形式で教師プロフィールを編集
 */
const ProfileEditModal = ({ isOpen, onClose, teacherId, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await teacherAPI.updateTeacherProfile(teacherId, formData);
    ...
    const handleAvatarChange = async (e) => {
        ...
        try {
            ...
            // Cloudinaryにアップロード
            const result = await teacherAPI.uploadTeacherAvatar(teacherId, file);
                ...
                >
                    ...
                    <div className="p-6">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div className="bg-gray-50 rounded-xl p-6 space-y-6">
                                        ...
                                        <div className="text-center">
                                            <input
                                                ...
                                                className="text-xl font-bold text-center w-full border-b-2 border-gray-300 focus:border-blue-500 focus:outline-none focus:ring-0 px-2 py-1 bg-transparent"
                                            />
                                            <input
                                                type="text"
                                                name="jobTitle"
                                                ...
                                                onChange={handleChange}
                                                placeholder="職種"
                                                className="text-sm text-gray-600 text-center w-full border-b border-gray-200 focus:border-blue-500 focus:outline-none focus:ring-0 px-2 py-1 mt-2 bg-transparent"
                                            />
                                        </div>
                                        ...
                                        <div className="space-y-3 text-sm">
                                            <div className="flex items-center justify-between py-2 border-b border-gray-100">
                                                ...
                                                <select
                                                    ...
                                                    onChange={handleChange}
                                                    className="flex-1 text-right border-none focus:outline-none focus:ring-0 text-gray-900 bg-transparent"
                                                >
                                ...
                                <div className="lg:col-span-2 space-y-6">
                                    ...
                                    <div className="bg-gray-50 rounded-xl p-6">
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-0 focus:border-blue-500"
                                        />
                                    </div>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-0 focus:border-blue-500"
                                                />
                                            </div>
                            ...
                            {/* Footer - ボタン */}
                            <div className="sticky bottom-0 bg-white border-t border-gray-200 -mx-6 -mb-6 px-6 py-4 flex justify-center gap-4 rounded-b-2xl">
                                <button
                                    type="submit"
                                    disabled={saving}
